...
import com.gk.study.AlipayFaceToFace;
import com.gk.study.utils.CommonUtils;
import com.alibaba.fastjson.JSONObject;
import com.gk.study.entity.ZFBFaceToFaceModel;
...
public class AlipayFaceToFaceController {
    ...
    public Map<String,Object> ZFBPreorderAction(HttpServletRequest request,HttpServletResponse response){
        ...
        try {
            ...
            //(必填)商户唯一订单编号
            String outTradeNo= commonUtils.getZFBinfoValue("pid");
