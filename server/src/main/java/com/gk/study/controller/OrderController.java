...
public class OrderController {
    ...
    public APIResponse create(Order order) throws IOException {
        ...
        return new APIResponse(ResponeCode.SUCCESS, "Create Successfully");
    }
    ...
    public APIResponse delete(String ids){
        ...
        return new APIResponse(ResponeCode.SUCCESS, "Delete Successfully");
    }
    ...
    public APIResponse cancelOrder(Long id) throws IOException {
        ...
        service.updateOrder(order);
        return new APIResponse(ResponeCode.SUCCESS, "Cancel Successfully");
    }
