...
public class ThingController {
    ...
    public APIResponse list(String keyword, String sort, String c, String tag){
        ...
        return new APIResponse(ResponeCode.SUCCESS, "Successfully", list);
    }
    ...
    public APIResponse detail(String id){
        ...
        return new APIResponse(ResponeCode.SUCCESS, "Successfully", thing);
    }
    ...
    public APIResponse create(Thing thing) throws IOException {
        ...
        return new APIResponse(ResponeCode.SUCCESS, "Successfully");
    }
