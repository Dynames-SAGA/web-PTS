<template>
  <div class="main-bar-view">
    <div class="logo">
      ...
      <span class="tutoring-system">Personal Tutoring System</span>
    </div>
...
<!--      <a-button type="link" @click="handleJoin()">Personal Tutoring In</a-button>-->

      <template v-if="userStore.user_token">
        <button class="login btn hidden-sm" @click="quit()">Logout</button>
<!--        <a-dropdown>-->
