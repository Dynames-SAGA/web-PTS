<template>
  <div class="main-bar-view">
    ...
    <div class="search-entry">
      ...
      <input placeholder="Please enter keywords" ref="keywordRef" @keyup.enter="search" />
    </div>
    <div class="right-view">
      <a-button type="link" @click="handleJoin()">To Be Tutor</a-button>
      <template v-if="userStore.user_token">
        <a-dropdown>
          ...
          <template #overlay>
            <a-menu>
              <a-menu-item>
                <a @click="goUserCenter('userInfoEditView')">Setting</a>
              </a-menu-item>
              <a-menu-item>
                <a @click="quit()">Quit</a>
              </a-menu-item>
