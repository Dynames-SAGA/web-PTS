      ...
      <div class="list-content">
        <div class="edit-view">
          <div class="item flex-view">
            ...
            <div class="right-box avatar-box flex-view">
              ...
              <div class="change-tips flex-view">
                ...
                <p class="tip">Supported image formats: GIF, PNG, JPEG. Must be larger than 200 PX and smaller than 4 MB.</p>
              </div>
            </div>
          </div>
          <div class="item flex-view">
            ...
            <div class="right-box">
              <input type="text" v-model="tData.form.nickname" placeholder="Please enter nickname" maxlength="20" class="input-dom">
          ...
          <div class="item flex-view">
            ...
            <div class="right-box">
              <input type="text" v-model="tData.form.mobile" placeholder="Please enter phone number" maxlength="100" class="input-dom web-input">
            </div>
          </div>
          <div class="item flex-view">
            <div class="label">Email</div>
            <div class="right-box">
              <input type="text" v-model="tData.form.email" placeholder="Please enter email" maxlength="100" class="input-dom web-input">
            </div>
          </div>
          <div class="item flex-view">
          ...
          <textarea v-model="tData.form.description" placeholder="Please enter introduction" maxlength="200" class="intro">
              ...
              <p class="tip">Limit to 200 words.</p>
            </div>
          </div>
