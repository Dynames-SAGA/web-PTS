<template>
  <div id="userLayout">
    <div class="user-layout-header">
      ...
      <span>Personal Tutoring Back Office</span>
    </div>
    <div class="main-container">
      <div class="main">
        <div class="main_right">
          ...
          >
            <a-form-item name="username" label="Admin name" :colon="false">
              <a-input
                  size="large"
                  placeholder="Please enter your admin name"
                  v-model:value="data.loginForm.username"
                  @pressEnter="handleSubmit">
                <a-icon slot="prefix" type="user"/>
              </a-input>
            </a-form-item>
            <a-form-item name="password" label="Passwd" :colon="false">
              <a-input
                  size="large"
                  type="password"
                  placeholder="please enter your passwd"
...
import logoImage from '../../../../../../java_jiajiao/java_jiajiao-master/web/src/assets/images/k-logo.png';
...
const data = reactive({
  ...
  rules: {
    ...
    password: [
      {required: true, message: 'Please enter passwd', trigger: 'blur'}
    ]
  }
})
