  ...
  <a-layout id="components-layout-demo-custom-trigger">
    <a-layout-header style="background: #fff; padding: 0">
      <div class="header">
        ...
        <span class="header-title">Personal Tutoring Back Office Management System</span>
        <div class="empty"></div>
        <a-button style="margin-right: 24px" @click="handlePreview">Frontend Preview</a-button>
