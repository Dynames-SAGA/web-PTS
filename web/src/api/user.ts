...
enum URL {
    ...
    sendResetPasswordEmail = '/api/user/sendResetPasswordEmail',
...
const sendResetPasswordEmailApi = async (data: any) => post<any>({ url: URL.sendResetPasswordEmail, data: data, headers: { 'Content-Type': 'multipart/form-data;charset=utf-8' } });
const resetPwdApi = async (data: any) => post<any>({ url: URL.resetPwd, data: data, headers: { 'Content-Type': 'multipart/form-data;charset=utf-8' } });
export { loginApi, listApi, detailApi, createApi, updateApi, deleteApi, userLoginApi, userRegisterApi, updateUserPwdApi, updateUserInfoApi, sendResetPasswordEmailApi, resetPwdApi };
